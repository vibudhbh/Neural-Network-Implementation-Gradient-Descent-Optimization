...
"""
Define the network architecture according to the assignment specifications.
"""
...
def main():
    ...
    # Verify parameter count matches the expected value
    expected_params = 81678
    assert param_count == expected_params, f"Parameter count mismatch: got {param_count}, expected {expected_params}"
