...
public class Log {
    ...
    public static void fatal(String message) {
        if (Log.FATAL <= level) System.out.println(Color.RED_BOLD_BRIGHT + "[FATAL  ] " + message + Color.RESET);
    }
    ...
    public static void error(String message) {
        if (Log.ERROR <= level) System.out.println(Color.RED_BOLD_BRIGHT + "[ERROR  ] " + message + Color.RESET);
    }
    ...
    public static void warning(String message) {
        if (Log.WARNING <= level) System.out.println(Color.YELLOW_BOLD_BRIGHT + "[WARNING] " + message + Color.RESET);
    }
